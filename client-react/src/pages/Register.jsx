...
// Registration screen — mirrors the dark AeroReply visual language used on
// the landing page and the Login screen. Wired to the real `register()`
// call from AuthContext; no mock/static submit handling remains.
  ...
  return (
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <p style={styles.subtitle}>Set up access to your agent dashboard.</p>
